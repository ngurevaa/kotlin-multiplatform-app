...
struct DarkModeIconShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addQuadCurve(to: s(638, 700), control: s(568, 760))
        path.addQuadCurve(to: s(740, 585), control: s(708, 610))
        path.addQuadCurve(to: s(700, 593), control: s(670, 710))
        path.addQuadCurve(to: s(620, 596), control: s(650, 600))
