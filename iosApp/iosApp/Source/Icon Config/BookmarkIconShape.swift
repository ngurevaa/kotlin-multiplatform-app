...
struct BookmarkIconShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        // Внутренний контур
        path.move(to: s(480, 632))
        path.addLine(to: s(680, 718))
        path.addLine(to: s(680, 200))
        path.addLine(to: s(280, 200))
        path.addLine(to: s(280, 718))
        path.addLine(to: s(480, 632))
        path.closeSubpath()

        // Нижняя горизонтальная линия (дублируется)
        path.move(to: s(480, 200))
        path.addLine(to: s(680, 200))
        path.addLine(to: s(480, 200))
